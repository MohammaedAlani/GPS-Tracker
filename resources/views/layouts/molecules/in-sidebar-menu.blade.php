...
@if ($AUTH->adminMode())
    ...
    @php ($active = str_starts_with($ROUTE, 'role') || str_starts_with($ROUTE, 'permission'))
        ...
        <ul class="{{ $active ? 'side-menu__sub-open' : '' }}">
            <li>
                <a href="{{ route('role.index') }}"
                   class="side-menu {{ Route::is('role.index') ? 'side-menu--active' : '' }}">
                    <div class="side-menu__icon">@icon('list')</div>
            ...
            <li>
                <a href="{{ route('permission.index') }}"
                   class="side-menu {{ Route::is('permission.index') ? 'side-menu--active' : '' }}">
                    <div class="side-menu__icon">@icon('plus-circle')</div>
    ...
    <li>
        ...
        <ul class="{{ $active ? 'side-menu__sub-open' : '' }}">
            ...
            <li>
                <a href="{{ route('monitor.log.path') }}"
                   class="side-menu {{ str_starts_with($ROUTE, 'monitor.log') ? 'side-menu--active' : '' }}">
